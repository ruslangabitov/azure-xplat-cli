...
exports.init = function (cli) {
  ...
  appGateway.command('create [resource-group] [name] [location]')
    ...
    .option('-v, --cert-file <cert-file>', $('the path to the certificate'))
    .option('-x, --cert-password <cert-password>', $('the certificate password'))
    .option('-g, --gateway-ip-name <gateway-ip-name>', $('the name of the gateway ip configuration'))
    .option('-w, --address-pool-name <address-pool-name>', $('the name of the backend address pool'))
    .option('-r, --servers <servers>', $('comma separated list of IP addresses or DNS names corresponding to backend servers'))
    .option('-b, --http-settings-name <http-settings-name>', $('the name of the HTTP settings'))
    ...
    .option('-i, --frontend-port-name <frontend-port-name>', $('the name of the frontend port'))
    .option('-j, --frontend-port <frontend-port>', util.format($('the frontend port value, valid range is'),
      utils.toRange(constants.appGateway.settings.port)))
    .option('-k, --frontend-ip-name <frontend-ip-name>', $('the name of the frontend ip configuration'))
    .option('-u, --routing-rule-name <routing-rule-name>', $('the name of the request routing rule'))
    ...
    .option('-y, --http-listener-name <http-listener-name>', $('the name of the HTTP listener'))
  ...
  appGateway.command('set [resource-group] [name] [location]')
    ...
    .execute(function (resourceGroup, name, location, options, _) {
      ...
      var networkManagementClient = getNetworkResourceProviderClient(options);
      var appGateway = new AppGateway(cli, networkManagementClient);
      appGateway.set(resourceGroup, name, location, options, _);
    });
  ...
  appGateway.command('show [resource-group] [name]')
    ...
    .usage('[options] <resource-group> <name> <vnet-name> <subnet-name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-n, --name <name>', $('the name of the application gateway'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, name, options, _) {
  ...
  appGatewaySslCert.command('add [resource-group] [gateway-name] [name]')
    ...
    .usage('[options] <resource-group> <gateway-name> <cert-name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
  ...
  appGatewayIpConfig.command('add [resource-group] [gateway-name] [subnet-name] [name]')
    .description($('Add an ip config to an Application Gateway'))
    .usage('[options] <resource-group> <gateway-name> <subnet-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    ...
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, gatewayName, subnetName, name, options, _) {
      resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
      gatewayName = cli.interaction.promptIfNotGiven($('Application Gateway name: '), gatewayName, _);
      name = cli.interaction.promptIfNotGiven($('Ip config name: '), name, _);
      options.vnetName = cli.interaction.promptIfNotGiven($('Subnet name: '), options.vnetName, _);
      options.subnetName = cli.interaction.promptIfNotGiven($('Subnet name: '), options.subnetName, _);

      var networkManagementClient = getNetworkResourceProviderClient(options);
      var appGateway = new AppGateway(cli, networkManagementClient);
      appGateway.addIpConfig(resourceGroup, gatewayName, name, options, _);
    });

  appGatewayIpConfig.command('remove [resource-group] [gateway-name] [name]')
    .description($('Remove an ip config to an Application Gateway'))
    .usage('[options] <resource-group> <gateway-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-w, --gateway-name <gateway-name>', $('the name of the Application Gateway'))
    ...
    .execute(function (resourceGroup, gatewayName, name, options, _) {
      ...
      var networkManagementClient = getNetworkResourceProviderClient(options);
      var appGateway = new AppGateway(cli, networkManagementClient);
      appGateway.removeIpConfig(resourceGroup, gatewayName, name, options, _);
    });
  ...
  appGatewayFrontendIp.command('add [resource-group] [gateway-name] [name]')
    ...
    .option('-v, --vnet-name <vnet-name>', $('the name of the virtual network'))
    .option('-k, --subnet-name <subnet-name>', $('the name of the subnet'))
    ...
    .execute(function (resourceGroup, gatewayName, name, options, _) {
      ...
      if (options.vnetName || options.subnetName) {
        options.vnetName = cli.interaction.promptIfNotGiven($('Frontend IP name: '), options.vnetName, _);
        options.subnetName = cli.interaction.promptIfNotGiven($('Frontend IP name: '), options.subnetName, _);
      } else {
        if(!options.subnetId) {
  ...
  appGatewayHttpListener.command('add [resource-group] [gateway-name] [name] [frontend-port-name]')
    .description($('Add an http listener to an Application Gateway'))
    .usage('[options] <resource-group> <gateway-name> <name> <frontend-port-name>')
    .option('-w, --gateway-name <gateway-name>', $('the name of the Application Gateway'))
  ...
  appGatewayRoutingRule.command('add [resource-group] [gateway-name] [name] [http-settings] [http-listener] [address-pool]')
    .description($('Add request routing rule to Application Gateway'))
    .usage('[options] <resource-group> <gateway-name> <name> <http-settings> <http-listener> <address-pool>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-w, --gateway-name <gateway-name>', $('the name of the Application Gateway'))
