...
exports.init = function (cli) {
  ...
  appGatewaySslCert.command('add [resource-group] [name] [cert-name]')
    ...
    .execute(function (resourceGroup, name, certName, options, _) {
      ...
      var networkManagementClient = getNetworkResourceProviderClient(options);
      var appGateway = new AppGateway(cli, networkManagementClient);
      appGateway.addSsl(resourceGroup, name, certName, options, _);
    });

  appGatewaySslCert.command('remove [resource-group] [name] [cert-name]')
    ...
    .execute(function (resourceGroup, name, certName, options, _) {
      ...
      var networkManagementClient = getNetworkResourceProviderClient(options);
      var appGateway = new AppGateway(cli, networkManagementClient);
      appGateway.removeSsl(resourceGroup, name, certName, options, _);
    });
  ...
  appGatewayFrontendPort.command('add [resource-group] [gateway-name] [name] [port]')
    ...
    .execute(function (resourceGroup, gatewayName, name, port, options, _) {
      ...
      var networkManagementClient = getNetworkResourceProviderClient(options);
      var appGateway = new AppGateway(cli, networkManagementClient);
      appGateway.addFrontendPort(resourceGroup, gatewayName, name, port, options, _);
    });
