...
exports.init = function (cli) {
  ...
  appGatewayFrontendIp.command('add [resource-group] [gateway-name] [name]')
    ...
    .option('-b, --vnet-name <vnet-name>', $('the name of the virtual network'))
    .option('-b, --subnet-name <subnet-name>', $('the name of the subnet'))
    .option('-b, --subnet-id <subnet-id>', $('the id of the subnet'))
    .option('-i, --static-ip-address <static-ip-address>', $('the static IP address name'))
  ...
  appGatewayHttpListener.command('add [resource-group] [gateway-name] [name] [frontend-port-name]')
    ...
    .option('-t, --protocol <protocol>', util.format($('the protocol, supported values are \[%s\], ' +
      '\n     default is [%s]'), constants.appGateway.httpListener.protocol, constants.appGateway.httpListener.protocol[0]))
